...
public abstract class BaseCaptureActivity extends Activity implements SurfaceHolder.Callback,ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    protected void onResume() {
        ...
        if (ContextCompat.checkSelfPermission(getApplication(), Manifest.permission.CAMERA)
            ...
            // 没有权限，申请权限。
            ActivityCompat.requestPermissions(BaseCaptureActivity.this,
        ...
        if(requestCode==0){
            if(permissions[0].equals(Manifest.permission.CAMERA)){
                ...
                if (hasSurface) {
                    ...
                    // Install the callback and wait for surfaceCreated() to init the camera.
                    surfaceHolder.addCallback(BaseCaptureActivity.this);
                }
            }
        }
    }
